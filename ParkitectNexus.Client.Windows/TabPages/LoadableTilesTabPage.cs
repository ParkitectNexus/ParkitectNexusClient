...
namespace ParkitectNexus.Client.Windows.TabPages
{
    public abstract class LoadableTilesTabPage : MetroTabPage
    {
        ...
        /// <summary>
        /// Raises the <see cref="E:System.Windows.Forms.Control.Enter"/> event of the <see cref="T:System.Windows.Forms.TabPage"/>.
        /// </summary>
        ...
        /// <summary>
        /// Raises the <see cref="E:System.Windows.Forms.Control.Leave"/> event of the <see cref="T:System.Windows.Forms.TabPage"/>.
        /// </summary>
        /// <param name="e">An <see cref="T:System.EventArgs"/> that contains the event data.</param>
        ...
        public async void RefreshTiles()
        {
            ...
            _progressSpinner.Location = new Point(Size.Width / 2 - _progressSpinner.Width / 2, Size.Height / 2 - _progressSpinner.Height / 2);
