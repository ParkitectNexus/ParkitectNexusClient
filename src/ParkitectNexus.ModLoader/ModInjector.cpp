...
int ParkitectNexus::ModLoader::ModInjector::Inject(System::String ^logPath, System::String ^dllPath, System::String ^nameSpace,
    System::String ^className, System::String ^methodName)
{
    IntPtr p0 = Marshal::StringToHGlobalAnsi(logPath);
    ...
    char* s0 = static_cast<char*>(p0.ToPointer());
    ...
    int result = inject(s0, s1, "Parkitect.exe", s2, s3, s4);
